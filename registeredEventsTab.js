...
export default class RegisteredEventTab extends Component {
  ...
  returnCards = ()=>{
    ...
    for(let i = 0; i<this.state.events.length; i++){
      cards.push(
        <RegisteredEventCard key={i} eventId={this.state.events[i].eventId} eventName={this.state.events[i].eventName}/>
      )
    }
          ...
          return (
              <ScrollView style={{backgroundColor: 'white'}}>
                ...
                <View style={styles.navBar}>
                  <TouchableNativeFeedback onPress={this.handleClick} background={TouchableNativeFeedback.Ripple('#ffffff', true)}>
