    ...
    if(this.state.message == 'Home' || this.props.message == 'Home')
        ...
        return (
          ...
          <View style={styles.container}>
            ...
            <TouchableNativeFeedback onPress={this.handleClick.bind(this, 'cult')} background={TouchableNativeFeedback.Ripple(colors.white, false)}>
              <View style={styles.categoryTeal}><Text style={styles.categoryLabelWhite}>{categoryNames[1]}</Text></View>
            </TouchableNativeFeedback>
            <TouchableNativeFeedback onPress={this.handleClick.bind(this, 'lect')} background={TouchableNativeFeedback.Ripple(colors.teal, false)}>
              <View style={styles.category}><Text style={styles.categoryLabel}>{categoryNames[2]}</Text></View>
            </TouchableNativeFeedback>
            <TouchableNativeFeedback onPress={this.handleClick.bind(this, 'shows')} background={TouchableNativeFeedback.Ripple(colors.white, false)}>
              <View style={styles.categoryTeal}><Text style={styles.categoryLabelWhite}>{categoryNames[4]}</Text></View>
            </TouchableNativeFeedback>
            <TouchableNativeFeedback onPress={this.handleClick.bind(this, 'reg')} background={TouchableNativeFeedback.Ripple(colors.teal, false)}>
