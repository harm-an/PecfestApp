      ...
      return(
        ...
        <View>
          <TouchableNativeFeedback background={TouchableNativeFeedback.Ripple(colors.teal, false)}>
            <View style={{width: Dimensions.get('window').width, paddingTop: 16, paddingBottom: 16, justifyContent: 'center', elevation: 0, borderRadius: 4, marginLeft: 0, marginTop: 0, marginBottom: 0, marginRight: 0, paddingLeft: 16, paddingRight: 16}}>
              <Text style={{fontSize: 26, fontFamily: 'Montserrat-Medium', color: colors.normal}}>{this.state.event.name}</Text>
              <Text style={{fontFamily: 'Montserrat-Regular', color: colors.teal, fontSize: 14}}>Day {this.state.event.day} @ {this.state.event.time}</Text>
              <Text style={{fontFamily: 'Montserrat-Regular', color: colors.teal, fontSize: 14}}>Venue: {this.state.event.location}</Text>
            </View>
          </TouchableNativeFeedback>
