      ...
      for(let i = 0; i<sub_categories.length; i++){
        ...
        organiserViews.push(
          <View key={i} style={{flex: 1}}>
            ...
            <View style={{height:Dimensions.get('window').width/0.7, width: Dimensions.get('window').width, justifyContent: 'center', alignItems: 'center'}}>
              <View style ={{height: w/0.7, width: w, justifyContent: 'center', alignItems: 'center'}}>
                <ImageBackground source={{uri: 'http://pecfest.in'+sub_categories[i].posterUrl}} style={{width: w-32, height: (w-32)/0.7, backgroundColor: '#f0f0f0'}}/>
              </View>
            </View>
          </View>
        )
